      ...
      <div className="page">
        <div className="section-head">
          <div>
            ...
            <h2 className="section-title">Solana-first. EVM where it&rsquo;s asked for.</h2>
          </div>
        </div>
        ...
        <div className="arch-grid">
          <div className="arch-card green">
            ...
            <p className="arch-desc">
              ...
              reference price. Every quote is bundle-eligible via Jito for atomic, MEV-shielded landing.
              Price improvement is included in the displayed output, not rebated separately.
            </p>
          ...
          <div className="arch-card blue">
            <div className="arch-head">
              <span className="arch-layer-tag">EVM Layer · Cross-chain reach</span>
            </div>
            <div className="arch-title">
